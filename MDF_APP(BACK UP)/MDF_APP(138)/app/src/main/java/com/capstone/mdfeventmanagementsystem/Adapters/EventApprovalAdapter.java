...
public class EventApprovalAdapter extends RecyclerView.Adapter<EventApprovalAdapter.EventViewHolder> {
    ...
    private String formatDate(String dateStr) {
        ...
        try {
            ...
            Log.e("EventApprovalAdapter", "Error formatting date: " + dateStr, e);
    ...
    private String formatTime(String timeStr) {
        ...
        try {
            ...
            Log.e("EventApprovalAdapter", "Error formatting time: " + timeStr, e);
    ...
    public void onBindViewHolder(@NonNull EventViewHolder holder, int position) {
        ...
        // Set dates and times using formatted values
        holder.startDateText.setText("Start: " + formatDate(event.getStartDate()));
        holder.startTimeText.setText(formatTime(event.getStartTime()));
        holder.endDateText.setText("End: " + formatDate(event.getEndDate()));
        holder.endTimeText.setText(formatTime(event.getEndTime()));
