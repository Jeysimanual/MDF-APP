...
public class StudentForgetPass extends BaseActivity {
    ...
    private DatabaseReference studentsRef, teachersRef;
        ...
        studentsRef.orderByChild("email").equalTo(email).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    sendPasswordResetEmail(email, "student");
                } else {
    ...
    private void checkTeacherEmail(String email) {
        teachersRef.orderByChild("email").equalTo(email).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists()) {
                    ...
                    sendPasswordResetEmail(email, "teacher");
                } else {
                    // Email not found in either students or teachers collection
                    emailEditText.setError("No account found with this email address.");
                    Toast.makeText(StudentForgetPass.this,
                            "This email is not registered as a student or teacher.",
                            Toast.LENGTH_LONG).show();
                }
            }
    ...
    private void sendPasswordResetEmail(String email, String userType) {
                ...
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        ...
                        if ("teacher".equals(userType)) {
                            successMessage += " to teacher account";
                        } else {
                            successMessage += " to student account";
                        }
