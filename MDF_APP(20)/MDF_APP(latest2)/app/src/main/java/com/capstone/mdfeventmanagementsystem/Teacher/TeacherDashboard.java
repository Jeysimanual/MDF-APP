...
public class TeacherDashboard extends AppCompatActivity {
    ...
    // NEW FUNCTION: Retrieves and displays the teacher's grade and section
    ...
    // NEW FUNCTION: Method to fetch and display total students in teacher's section
    ...
    // NEW FUNCTION: Method to count students matching the teacher's year level and section
