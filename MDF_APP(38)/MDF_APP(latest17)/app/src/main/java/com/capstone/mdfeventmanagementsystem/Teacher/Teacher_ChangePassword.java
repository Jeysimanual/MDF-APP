...
public class Teacher_ChangePassword extends BaseActivity {

    private static final String TAG = "TeacherChangePassword";
    ...
    private String teacherId, teacherEmail;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View.OnClickListener goBackListener = v -> {
            Intent intent = new Intent(Teacher_ChangePassword.this, TeacherProfile.class);
        ...
        // Get teacher ID from UserSession SharedPreferences (matching TeacherLogin)
        ...
        // Find the teacher's ID from Firebase using their email
        ...
        teachersRef.orderByChild("email").equalTo(teacherEmail)
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if (dataSnapshot.exists()) {
                            for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                                teacherId = snapshot.getKey();
                                teacherRef = FirebaseDatabase.getInstance().getReference("teachers").child(teacherId);
                                Log.d(TAG, "Found teacher ID: " + teacherId);
                            }
                        } else {
                            Log.e(TAG, "No teacher found with email: " + teacherEmail);
                            Toast.makeText(Teacher_ChangePassword.this, "Teacher data not found", Toast.LENGTH_SHORT).show();
                            navigateToMainActivity();
                        }
                    }
                    ...
                    public void onCancelled(@NonNull DatabaseError error) {
                        ...
                        Toast.makeText(Teacher_ChangePassword.this, "Error fetching user data", Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    private void validateAndChangePassword() {
        ...
        if (user != null && teacherEmail != null) {
            // Re-authenticate with Firebase Auth
            auth.signInWithEmailAndPassword(teacherEmail, oldPassword)
    ...
    private void updatePassword(String newPassword) {
        if (teacherRef == null) {
            Log.e(TAG, "Teacher reference is null");
        ...
        if (user != null) {
            user.updatePassword(newPassword)
                    .addOnSuccessListener(aVoid -> {
                        ...
                        teacherRef.updateChildren(updates)
                                .addOnSuccessListener(dbVoid -> {
                                    Log.d(TAG, "Password successfully updated in both Auth and Database");
                                    Toast.makeText(Teacher_ChangePassword.this, "Password successfully changed", Toast.LENGTH_SHORT).show();
                                ...
                                .addOnFailureListener(e -> {
                                    ...
                                    Toast.makeText(Teacher_ChangePassword.this, "Password updated in Auth but failed in Database", Toast.LENGTH_SHORT).show();
                                    logout(); // Still logout as auth password is changed
                                });
                    })
                    .addOnFailureListener(e -> {
                        Log.e(TAG, "Error updating password in Auth: " + e.getMessage());
                        Toast.makeText(Teacher_ChangePassword.this, "Failed to update password: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    });
        }
    }
    ...
    private void navigateToMainActivity() {
        Intent intent = new Intent(Teacher_ChangePassword.this, MainActivity.class);
