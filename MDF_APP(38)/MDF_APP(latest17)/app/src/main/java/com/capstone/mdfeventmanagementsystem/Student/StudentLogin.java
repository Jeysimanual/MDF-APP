...
import com.capstone.mdfeventmanagementsystem.Teacher.TeacherForgotPassActivity;
...
public class StudentLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView forgotPassText = findViewById(R.id.tvForgotPassword); // Access your TextView by its ID
