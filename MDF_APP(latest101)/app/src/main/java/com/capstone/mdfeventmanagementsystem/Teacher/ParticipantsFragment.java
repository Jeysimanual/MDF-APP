...
public class ParticipantsFragment extends Fragment {
    ...
    // Add this new method to check each day of a multi-day event and update attendance status
    ...
    private void exportToCSV() {
        try {
            ...
            String baseFileName = sanitizedEventName + "_Attendance.csv";
    ...
    private void writeCSVFile(String fileName, List<Participant> dataToExport) {
        try {
            ...
            // Common code for both Android versions
            ...
            // Write CSV header
            bufferedWriter.write("Name,Section,Time In,Time Out,Status\n");
            ...
            for (Participant participant : dataToExport) {
                ...
                // Process fields the same as your original code
                // Name
    ...
    private void showExportSuccessDialog(String filePath, Uri fileUri) {
        ...
        lastExportedFileName = filePath.substring(filePath.lastIndexOf("/") + 1);
    ...
    private void shareCSVFile(Uri fileUri) {
        try {
            ...
            shareIntent.putExtra(Intent.EXTRA_SUBJECT, eventName + " ATTENDANCE Data");
