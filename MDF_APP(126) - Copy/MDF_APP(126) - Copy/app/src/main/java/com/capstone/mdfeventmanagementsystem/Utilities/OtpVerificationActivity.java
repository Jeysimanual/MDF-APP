        ...
        auth.createUserWithEmailAndPassword(email.toLowerCase(), password)
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        Log.d(TAG, "Firebase Auth user created for email: " + email.toLowerCase());
                        ...
                        databaseReference.child(studentId).updateChildren(updates)
                                .addOnSuccessListener(aVoid -> {
                                    Log.d(TAG, "Student data updated for studentId: " + studentId + ", email: " + email.toLowerCase());
                                    // Clear MyAppPrefs
                                    ...
                                    Toast.makeText(OtpVerificationActivity.this, "Account verified successfully! Please log in.", Toast.LENGTH_LONG).show();
                                    navigateToLogin();
                                })
                                .addOnFailureListener(e -> {
                                    Log.e(TAG, "Failed to update student data for studentId: " + studentId + ", error: " + e.getMessage());
                                    Toast.makeText(OtpVerificationActivity.this, "Verification failed: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                                });
                    } else {
                        Log.e(TAG, "Error creating Firebase Auth user: " + task.getException().getMessage());
